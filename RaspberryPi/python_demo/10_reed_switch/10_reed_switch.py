# !/usr/bin/env python3
# -*- coding: utf-8 -*-
# file name: reed_switch.py
# version: 1.0
# author: Neal Shen
# ------------------------------------------------------------------
import RPi.GPIO as GPIO
makerobo_ReedPin = 11    # reed switch pin
...
def makerobo_setup():
    ...
    # interupt function
    GPIO.add_event_detect(makerobo_ReedPin, GPIO.BOTH, callback=makerobo_detect, bouncetime=200)
...
def makerobo_detect(chn):
    double_color(GPIO.input(makerobo_ReedPin))
